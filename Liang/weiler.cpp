...
vector<vector<point>> clip(point wMin, point wMax, vector<point> poly)
{
    ...
    sort(l.begin(), l.end(), [](boolPoint a, boolPoint b)
         { return (a.p.y > b.p.y); });
    sort(r.begin(), r.end(), [](boolPoint a, boolPoint b)
         { return (a.p.y < b.p.y); });
    sort(t.begin(), t.end(), [](boolPoint a, boolPoint b)
         { return (a.p.x > b.p.x); });
    sort(b.begin(), b.end(), [](boolPoint a, boolPoint b)
         { return (a.p.x < b.p.x); });
